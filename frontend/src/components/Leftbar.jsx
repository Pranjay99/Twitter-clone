...
const Leftbar = () => {
  ...
  return (
    <div className='md:w-[20%] w-[15%]'>
      <div>
        <Link to="/">
          <img className="md:ml-4 ml-2" width="50" src="https://img.freepik.com/free-vector/twitter-new-2023-x-logo-white-background-vector_1017-45422.jpg?size=338&ext=jpg&ga=GA1.1.1141335507.1718755200&semt=ais_user" alt="Twitter logo" />
        </Link>
        <div className='my-4'>
